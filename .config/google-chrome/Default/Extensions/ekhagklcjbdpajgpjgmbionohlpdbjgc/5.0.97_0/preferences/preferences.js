...
Zotero_Preferences.Advanced = {
  init: function () {
    ...
    document.getElementById("advanced-checkbox-show-in-console").onchange = function () {
      ...
      Zotero.Debug.bgInit(); // Zotero.Debug.init() sets store to false
  ...
  submitDebugOutput: async function () {
    ...
    toggleDisabled(submitOutputButton, true); // We have to request within a user gesture in chrome
  ...
  submitErrors: async function () {
    ...
    toggleDisabled(reportErrorsButton, true); // We have to request within a user gesture in chrome
...
Zotero_Preferences.Components.Proxies = class Proxies extends React.PureComponent {
  ...
  renderProxySettings() {
    ...
    let multiHost = currentProxy.scheme.indexOf('%h') != -1; // If a host exists in the last position and is empty, don't allow adding more
    ...
    return React.createElement("div", {
    ...
    }), "\xA0Automatically associate new hosts"), React.createElement("label", null, React.createElement("input", {
      type: "checkbox",
      name: "dotsToHyphens",
      onChange: this.handleCheckboxChange,
      checked: currentProxy.dotsToHyphens
    }), "\xA0Automatically convert between dots and hyphens in proxied hostnames")), React.createElement("p", {
      style: {
        display: "flex",
        alignItems: "center"
      }
    ...
    }, "Scheme: "), React.createElement("input", {
      style: {
        flexGrow: "1"
      },
      type: "text",
      ...
      value: currentProxy.scheme,
      ref: "schemeInput"
    })), React.createElement("p", null, "You may use the following variables in your proxy scheme:", React.createElement("br", null), "%h - The hostname of the proxied site (e.g., www.example.com)", React.createElement("br", null), "%p - The path of the proxied page excluding the leading slash (e.g., about/index.html)", React.createElement("br", null), "%d - The directory path (e.g., about/)", React.createElement("br", null), "%f - The filename (e.g., index.html)", React.createElement("br", null), "%a - Any string"), React.createElement("div", {
      style: {
        display: "flex",
